package com.example.a1918017_prakmobile6;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPeriodicTask = findViewById(R.id.btn_ubah_task);
        btnCancelPeriodicTask = findViewById(R.id.btn_cancel_task);
    ...
    private void startOneTimeTask(){
        ...
        Data data = new Data.Builder()
                .putString(WeatherWorkManager.EXTRA_CITY,spCity.getSelectedItem().toString())
                .build();
        ...
        OneTimeWorkRequest oneTimeWorkRequest = new OneTimeWorkRequest.Builder(WeatherWorkManager.class)
                .setInputData(data)
    ...
    private void startPeriodicTask(){
        ...
        periodicWorkRequest = new PeriodicWorkRequest.Builder(WeatherWorkManager.class, 15, TimeUnit.MINUTES)
                .setInputData(data)
                .setConstraints(constraints)
                .build();

...
public class WeatherWorkManager extends Worker
{
    ...
    private static final String TAG = WeatherWorkManager.class.getSimpleName();
    private Result resultStatus;

    public WeatherWorkManager(@NonNull Context context, @NonNull WorkerParameters workerParams) {
